    ...
    <Fragment>
      {open && (
        <div className="fixed h-full w-full top-0 left-0 flex z-[99999]">
          ...
          ></div>
          <div
            className={`h-full w-1/3 bg-white fixed top-0 bottom-0 right-0 transform transition-transform duration-200 ease-in-out text-black custom-scrollbar ${
                  ...
                  {JSON.parse(product.size).length > 1 ? (
                    <div className="px-6 mt-8">
                      ...
                      >
                        ...
                        {/* <li className="w-14 h-14 text-2xl flex justify-center items-center rounded-full border hover:border-black cursor-pointer">
                        S
                      </li>
                      <li className="w-14 h-14 text-2xl flex justify-center items-center rounded-full border hover:border-black cursor-pointer">
                        L
